...
script_path = 'FAnomAlly/scripts/classification_functs/classification_transfer.py'
...
with ThreadPoolExecutor(max_workers=num_cores) as executor:  # Adjust the number of workers as needed
    ...
    for i in range(0, nb_Ids, 100):
        ...
        folder_name = 'Classifications_arch2'
        
        futures.append(executor.submit(run_script, Id_first, Id_last+1, folder_name))
...
print("Temps écoulé:", elapsed_time/60, "min")
